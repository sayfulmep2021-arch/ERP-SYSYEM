...
(function(window) {
    ...
    const REPORT_MODULES_DATA = {
        'mod-01': {
            ...
            reports: [
                { title: 'Production Plan', url: 'modules/production/production_plan.html', highlight: true },
                { title: 'Monthly RM Demand Vs Received', url: 'modules/production/monthly_rm_demand_vs_received.html', highlight: true },
                { title: 'Assemble Summary', url: 'modules/production/assemble_summary.html' },
                { title: 'Armature Summary', url: 'modules/production/armature_summary.html' },
                { title: 'FG Summary', url: 'modules/production/fg_summary.html' },
                { title: 'BOM', url: 'modules/production/bom.html' },
                { title: 'RM Requirement Summary (BOM)', url: 'modules/production/rm_requirement_summary_bom.html' }
            ]
        },
        'mod-02': {
            ...
            reports: [
                { title: 'Daily FG Production Entry', url: 'modules/production/daily_fg_production_entry.html', highlight: true },
                { title: 'Daily Production Received Assemble (All)', url: 'modules/production/daily_production_received_assemble.html', highlight: true },
                { title: 'Daily Production Plan', url: 'modules/production/daily_production_plan.html', highlight: true },
                { title: 'Check Floor Stock', url: 'modules/production/check_floor_stock.html' },
                { title: 'Fan Damage Calculation Entry', url: 'modules/production/fan_damage_calculation_entry.html', highlight: true }
            ]
        },
        'mod-03': {
            ...
            reports: [
                { title: 'All Section SFG', url: 'modules/production/report_all_section_sfg.html', highlight: true, pill: '160 ITEMS' }
            ]
        },
        'mod-04': {
            name: 'Closing (ERP)',
            ...
            isClosing: true,
            reports: [
                { id: 'fan-assemble', title: 'Fan Assemble', url: 'modules/production/fan_assemble_erp.html', defaultDate: '2026-08-25' },
                { id: 'armature-winding', title: 'Armature & Winding', url: 'modules/production/armature_winding_erp.html', defaultDate: '2026-08-26' },
                { id: 'closing-fg', title: 'Finish Good (FG)', url: 'modules/production/closing_finish_good_fg.html', defaultDate: '2026-08-26', highlight: true },
                { id: 'closing-all-sfg', title: 'Closing All SFG', url: 'modules/production/closing_all_sfg.html', defaultDate: '2026-08-20', highlight: true },
                { id: 'store-position', title: 'Store Position Report', url: 'modules/production/store_position_report.html', defaultDate: '2026-08-26', highlight: true }
            ]
        },
        'mod-05': {
            ...
            reports: [
                { title: 'Monthly Production Summary', url: 'modules/production/monthly_production_summary_physical.html', highlight: true },
                { title: 'Monthly Damage Summary', url: 'modules/production/monthly_damage_summary.html', highlight: true }
            ]
        },
        'mod-06': {
            ...
            reports: [
                { title: 'Yearly Production Summary (Physical)', url: 'modules/production/yearly_production_summary_physical.html', highlight: true },
                { title: 'Yearly Production Summary (ERP)', url: 'modules/production/yearly_production_summary_erp.html', highlight: true },
                { title: 'Yearly Damage Summary', url: 'modules/production/yearly_damage_summary.html', highlight: true }
            ]
        },
        'mod-07': {
            name: 'Reject Report',
        ...
        'mod-08': {
            ...
            reports: [
                { title: 'FG Pending Report', url: 'modules/production/fg_pending_report.html', highlight: true }
            ]
        },
        'mod-pending': {
            name: 'Complete vs Pending',
        ...
        'mod-10': {
            ...
            reports: [
                { title: 'Month wish Assemble Summary', url: 'modules/production/assemble_summary.html' },
                { title: 'Month wish Armature Summary', url: 'modules/production/armature_summary.html' },
                { title: 'Yearly FG Summary ERP', url: 'modules/production/yearly_production_summary_erp.html' }
            ]
        },
        'mod-11': {
            ...
            iconSvg: '<path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>',
            reports: [
                { title: 'Check FG Need Item', url: 'modules/production/check_fg_need_item.html', highlight: true },
                { title: 'Check RM (Prd. Possible)', url: 'modules/production/check_rm_prd_possible.html', highlight: true },
                { title: 'BOM With SFG', url: 'modules/production/bom_with_sfg.html', highlight: true }
            ]
        },
        'mod-backup': {
            name: 'Data Backup',
        ...
        'mod-master': {
            ...
            reports: [
                { title: 'Central Item Master Database', url: 'modules/production/master.html', highlight: true, pill: 'VIP DB' }
            ]
        }
    };
    ...
    function renderReportsDrawerMenu(containerId) {
        ...
        DRAWER_MODULE_ORDER.forEach(item => {
            ...
            if (item.key === 'mod-master') {
                html += `
                    <div class="accordion-card master-menu-card" id="accordion-master" onclick="navigateToReportPage('modules/production/master.html', event)" role="button" tabindex="0" title="Click to open Central Master Database Management" onkeydown="if(event.key==='Enter'||event.key===' ') navigateToReportPage('modules/production/master.html', event)">
